...
// //     setCurrentItem({ ...currentItem, Cantidad: newQuantity });
// //   };

// //   const handleUpdate = async () => {
// //     try {
// //       const response = await fetch(`https://athleticstoreapi.integrador.xyz/api/wishlist/${currentItem.Id_Wish}`, {
// //         method: 'PUT',
// //         headers: {
// //           'Content-Type': 'application/json',
// //           'Authorization': localStorage.getItem('authToken'),
...
// //           item.Id_Wish === currentItem.Id_Wish ? currentItem : item
// //         ));
// //         closeModal();
// //       } else {
// //         const errorData = await response.json();
